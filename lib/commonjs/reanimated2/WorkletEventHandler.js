...
class WorkletEventHandler {
  ...
  registerForEvents(viewTag, fallbackEventName) {
    ...
    this.registrations = this.eventNames.map(eventName => _NativeReanimated.default.registerEventHandler(viewTag + eventName, this.worklet));
  ...
  unregisterFromEvents() {
    this.registrations.forEach(id => _NativeReanimated.default.unregisterEventHandler(id));
    this.registrations = [];
  }
