...
export function getProcessedConfig(animationName, config, isLayoutTransition, initialAnimationName) {
  return {
    animationName: animationName,
    duration: getDurationFromConfig(config, isLayoutTransition, initialAnimationName),
...
export function handleEnteringAnimation(element, animationConfig) {
  const {
    delay
  } = animationConfig;
